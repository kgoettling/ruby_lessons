...
# A: The string is now the object that is mutated by the 
# shovel operator and the array object outside the method
# remains unchanged, for the same reasons in the last problem.